...
public final class ComparatorArgDeclaration extends CommonArgDeclaration {
  ...
  public static final Argument finalColumns = new Argument("--final-columns", "Will print per-job columns at the bototm. No reasonable results? Limit tests via " + exactTestsArg.getName() + " The default value is false.", " <true/false>");
}
