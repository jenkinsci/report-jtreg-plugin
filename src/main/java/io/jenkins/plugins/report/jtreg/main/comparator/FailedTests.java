...
public class FailedTests {
    ...
    public static void printFailedTable(HashMap<String, ArrayList<String>> failedMap, Options.Operations operation, TablePrinter tablePrinter) {
        ...
        tablePrinter.printTable(table, failedMap.size() + 1, allFailedTests.size() + 1);
    }
}